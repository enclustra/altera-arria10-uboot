...
SOCFPGA_BOARD_CONFIG.SDMMC = socfpga_$(DEVICE_FAMILY)_rev1_defconfig
SOCFPGA_BOARD_CONFIG.EMMC = socfpga_$(DEVICE_FAMILY)_rev1_emmc_defconfig
else
...
SOCFPGA_BOARD_CONFIG.SDMMC = socfpga_$(DEVICE_FAMILY)_defconfig
SOCFPGA_BOARD_CONFIG.EMMC = socfpga_$(DEVICE_FAMILY)_emmc_defconfig
endif
